...
#if defined(NV_VGPU_KVM_BUILD)
	VUP_HOOK(0x003A1BA0, cudahost, 1, 0x41, 0x80, 0xBC, 0x24, 0x39, 0x07, 0x00, 0x00, 0x00),
	VUP_HOOK(0x00492D7B, vupdevid, 1, 0x89, 0x45, 0x0C, 0x48, 0x89, 0xd8),
	VUP_HOOK(0x0001409C, klogtrace,0, 0x48, 0x81, 0xED, 0x40, 0x04, 0x00, 0x00),
#else
	VUP_HOOK(0x00492D7B, vupdevid, 1, 0x89, 0x45, 0x0C, 0x48, 0x89, 0xd8),
	VUP_HOOK(0x0001409C, klogtrace,0, 0x48, 0x81, 0xED, 0x40, 0x04, 0x00, 0x00),
#endif
