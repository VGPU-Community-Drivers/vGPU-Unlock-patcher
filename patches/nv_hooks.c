...
#if defined(NV_VGPU_KVM_BUILD)
	VUP_HOOK(0x003E7334, cudahost, 1, 0x41, 0x80, 0xBE, 0xF1, 0x07, 0x00, 0x00, 0x00),
	VUP_HOOK(0x004E64E6, vupdevid, 1, 0x4C, 0x89, 0xE0, 0x44, 0x89, 0xFB),
	VUP_HOOK(0x0001423F, klogtrace,0, 0x48, 0x81, 0xED, 0x30, 0x04, 0x00, 0x00),
#else
	VUP_HOOK(0x004E64E6, vupdevid, 1, 0x4C, 0x89, 0xE0, 0x44, 0x89, 0xFB),
	VUP_HOOK(0x0001423F, klogtrace,0, 0x48, 0x81, 0xED, 0x30, 0x04, 0x00, 0x00),
#endif
...
static struct vup_patch_item vup_diff_sunlock[] = {
	...
	{ 0x00896C2A, 0x10, 0x00 },
};
VUP_PATCH_DEF(sunlock, 0, 1, 1);

static struct vup_patch_item vup_diff_gspvgpu[] = {
	{ 0x000321C5, 0x1B, 0x00 },
	{ 0x000321D1, 0x74, 0xEB },
	//{ 0x008842BA, 0x85, 0x31 },
};
...
static struct vup_patch_item vup_diff_general[] = {
	{ 0x000B8058, 0x75, 0xEB },
	{ 0x0089AB39, 0x09, 0x00 },
	{ 0x00A78862, 0x3D, 0x00 },

	//{ 0x00872BA9, 0x23, 0x21 },
};
